...
CREATE TABLE `users` (
    ...
    `role` ENUM('ADMIN', 'DRIVER', 'MANAGER', 'TECHNICIAN', 'USER') NOT NULL DEFAULT 'DRIVER',
...
CREATE TABLE `driver_vehicle_assignments` (
    ...
    INDEX `driver_vehicle_assignments_vehicle_id_fkey`(`vehicle_id`),
...
CREATE TABLE `components` (
    ...
    INDEX `components_vehicle_id_fkey`(`vehicle_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `trips` (
    ...
    INDEX `trips_driver_id_fkey`(`driver_id`),
    INDEX `trips_vehicle_id_fkey`(`vehicle_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `trip_metrics` (
    ...
    INDEX `trip_metrics_trip_id_fkey`(`trip_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `driver_evaluations` (
    ...
    INDEX `driver_evaluations_driver_id_fkey`(`driver_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `alerts` (
    ...
    INDEX `alerts_component_id_fkey`(`component_id`),
    INDEX `alerts_vehicle_id_fkey`(`vehicle_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `maintenance` (
    ...
    INDEX `maintenance_component_id_fkey`(`component_id`),
    INDEX `maintenance_vehicle_id_fkey`(`vehicle_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ai_recommendations` (
    ...
    INDEX `ai_recommendations_component_id_fkey`(`component_id`),
    INDEX `ai_recommendations_driver_id_fkey`(`driver_id`),
    INDEX `ai_recommendations_trip_id_fkey`(`trip_id`),
    INDEX `ai_recommendations_vehicle_id_fkey`(`vehicle_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
